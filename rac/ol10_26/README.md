...
Make sure you have the latest Oracle Linux 10 Vagrant box from Oracle.

```
# Download the box.
vagrant box add oraclelinux/10 https://oracle.github.io/vagrant-projects/boxes/oraclelinux/10.json --provider virtualbox

# If you already have the box, check you have the latest version.
vagrant box update --box oraclelinux/10
```
