# Vagrant 23c Real Application Clusters (RAC) Build

The Vagrant scripts here will allow you to build a 23c Real Application Clusters (RAC) system by just starting the VMs in the correct order.

If you need a more detailed description of this build, check out the article here.

* [Oracle Database 23c RAC On Oracle Linux 8 Using VirtualBox and Vagrant](https://oracle-base.com/articles/23c/oracle-db-23c-rac-installation-on-oracle-linux-8-using-virtualbox)
...
You will also need to download the 23c grid and database software, along with the latest combo patch for grid. This means you must have an Oracle Support account to complete this installation.

* [Grid : grid_home.zip](https://www.oracle.com/database/technologies/oracle23c-linux-downloads.html)
* [Database : db_home.zip](https://www.oracle.com/database/technologies/oracle23c-linux-downloads.html)
...
```
  asm_crs_disk_1: /u05/VirtualBox/shared/ol8_23_rac/asm_crs_disk_1.vdi
  asm_crs_disk_2: /u05/VirtualBox/shared/ol8_23_rac/asm_crs_disk_2.vdi
  asm_crs_disk_3: /u05/VirtualBox/shared/ol8_23_rac/asm_crs_disk_3.vdi
  asm_crs_disk_size: 2
  asm_data_disk_1: /u05/VirtualBox/shared/ol8_23_rac/asm_data_disk_1.vdi
  asm_data_disk_size: 40
  asm_reco_disk_1: /u05/VirtualBox/shared/ol8_23_rac/asm_reco_disk_1.vdi
  asm_reco_disk_size: 20
```

For example, if you were working on a Windows PC, you might create a path called "C:\VirtualBox\shared\ol8_23_rac" and use the following settings.

```
  asm_crs_disk_1: C:\VirtualBox\shared\ol8_23_rac\asm_crs_disk_1.vdi
  asm_crs_disk_2: C:\VirtualBox\shared\ol8_23_rac\asm_crs_disk_2.vdi
  asm_crs_disk_3: C:\VirtualBox\shared\ol8_23_rac\asm_crs_disk_3.vdi
  asm_crs_disk_size: 2
  asm_data_disk_1: C:\VirtualBox\shared\ol8_23_rac\asm_data_disk_1.vdi
  asm_data_disk_size: 40
  asm_reco_disk_1: C:\VirtualBox\shared\ol8_23_rac\asm_reco_disk_1.vdi
  asm_reco_disk_size: 20
```

If you don't alter them, they will get written to "C:\u05\VirtualBox\shared\ol8_23_rac".
...
default: [FATAL] [INS-40718] Single Client Access Name (SCAN):ol7-23-scan could not be resolved.
