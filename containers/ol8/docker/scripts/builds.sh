...
mkdir ~/java
cd ~/java
tar -xf /vagrant/software/OpenJDK11U-jdk_x64_linux_hotspot_11.0.19_7.tar.gz
ln -s ./j* ./latest
cd ~
...
cp /vagrant/software/apache-tomcat-9.0.74.tar.gz .
cp /vagrant/software/ords-latest.zip .
cp /vagrant/software/sqlcl-latest.zip .
cp /vagrant/software/OpenJDK11U-jdk_x64_linux_hotspot_11.0.19_7.tar.gz .
