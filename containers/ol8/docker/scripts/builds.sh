...
cd ~
unzip -oq /vagrant/software/sqlcl-22.1.1.131.0820.zip
mkdir ~/java
cd ~/java
...
cp /vagrant/software/apache-tomcat-9.0.63.tar.gz .
cp /vagrant/software/ords-22.1.1.133.1148.zip .
cp /vagrant/software/sqlcl-22.1.1.131.0820.zip .
