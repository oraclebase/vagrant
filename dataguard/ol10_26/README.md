# Vagrant 26ai Data Guard Build

The Vagrant scripts here will allow you to build a 26ai Data Guard system by just starting the VMs in the correct order.

If you need a more detailed description of this build, check out the article here.

* [Data Guard Physical Standby Setup Using the Data Guard Broker in Oracle Database 26ai](https://oracle-base.com/articles/26/data-guard-setup-using-broker-26)
...
You will also need to download the 26ai database software.

* [Database LINUX.X64_2326100_db_home.zip](https://www.oracle.com/database/technologies/oracle26ai-linux-downloads.html)
