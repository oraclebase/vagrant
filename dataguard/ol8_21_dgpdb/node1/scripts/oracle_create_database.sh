...
dbca -silent -createDatabase                                                  \
  ...
  -gdbname ${NODE1_DB_NAME}${DB_DOMAIN_STR}                                   \
  -characterSet AL32UTF8                                                      \
  -sysPassword ${SYS_PASSWORD}                                                \
  -systemPassword ${SYS_PASSWORD}                                             \
  -createAsContainerDatabase true                                             \
  -numberOfPDBs 1                                                             \
  -pdbName ${NODE1_PDB_NAME}                                                  \
  ...
  -initparams db_name=${NODE1_DB_NAME},db_unique_name=${NODE1_DB_UNIQUE_NAME} \
  -ignorePreReqs
...
alter pluggable database ${NODE1_PDB_NAME} save state;
...
echo "******************************************************************************"
echo "Create an autologin wallet." `date`
echo "******************************************************************************"
