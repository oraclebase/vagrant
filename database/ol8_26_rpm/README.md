# Oracle Database 26ai (RPM) on Oracle Linux 8

A simple Vagrant build for Oracle Database 26ai on Oracle Linux 8 using the RPM installation.
...
```
cd C:\git\oraclebase\vagrant\database\ol8_26_rpm\
vagrant up
```
