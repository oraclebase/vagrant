...
export PATCH_FILE="p31326362_190000_Linux-x86-64.zip"
export PATCH_TOP=${SOFTWARE_DIR}/31326362
export PATCH_PATH1=${PATCH_TOP}/31281355
export PATCH_PATH2=${PATCH_TOP}/31219897
